...
?>
  ...
  <section>
    <div class="header-inner two">
      <div class="inner text-center">
        <h4 class="title text-white uppercase">Oculoplasty</h4>
        <br>
        <div class="text-white"><a href="index.php" class="text-white">Home</a><i> / </i> Oculoplasty</div>
      </div>
  ...
  <div class="clearfix"></div>
    ...
    <?php
        $q="SELECT title,description,image,rank FROM mec_treatments WHERE category_id=2 AND status=1 ORDER BY rank";
