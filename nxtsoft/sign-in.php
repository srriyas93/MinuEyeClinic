            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    ...
                    <div class="body">
                        ...
                        <input type="submit" onClick="javascript:formIsValid('adminlogin','loginfm',event);" class="btn btn-primary btn-block waves-effect waves-light" name="login" value = "SIGN IN">
                        <div class="col-sm-12">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form name="FrmResetPasswordPop" id="FrmResetPasswordPop" method="POST">
                    ...
                    <div class="col-sm-12">
                        <div style='font-size: 15px;font-weight: bold;color:red' id="resetpassconfirmmessage"></div>
                    </div>
                </form>
            </div>
        </div>
